    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerviewABCD.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                Log.d("AllNewsFragment","First Visible Item ${ myLayOutManager.findFirstVisibleItemPosition() }")
        ...
        news.enqueue(object : Callback<NewsResponse?> {
            override fun onResponse(call: Call<NewsResponse?>, response: Response<NewsResponse?>) {
                ...
                if (data != null) {
                    ...
                    Log.d("AllNewsFragment", "Api Providing No Data, Developer accounts request limit exceeded ")
                    Toast.makeText(context, "Api Providing No Data, request limit exceeded", Toast.LENGTH_LONG).show()
                }
            }
